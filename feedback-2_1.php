        ...
        <form method="POST">
            ...
            <table class="mt-5 table table-striped table-bordered">
                ...
                <?php 
                    ...
                    $sql ="SELECT * FROM review WHERE StarRate LIKE '$star' AND StudentID = '$studentid' ORDER BY $sort $order";
                    ...
                    if ($result = $con->query($sql)){
                        ...
                        while($record = $result->fetch_object()){
                            printf("<tr>
                                ...
                                <td>%s</td>
                                <td>
                        <a href='edit-member-review.php?id=%s'>Edit</a>|
                        <a href='delete-member-review.php?id=%s'>Delete</a>
                        </td>
                                </tr>"
                                ,$record->ReviewID
                                ,$record->StudentID
                        ...
                        printf("<tr><td colspan='7'>%d record(s) returned.
                                [<a class='no-style' href='feedback-form-2.php'>Add Review</a>]
                                [<a class='no-style' href='all_feedback.php'>See All Review</a>]
